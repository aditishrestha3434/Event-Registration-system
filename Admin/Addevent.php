...
<title>Add Event | EventHub Admin</title>
...
<div class="wrapper">
    ...
    <?php if (isset($_GET['error'])): ?>
        <div class="alert error">Please fill in all fields correctly.</div>
    <?php endif; ?>
    ...
    <form action="Addeventaction.php" method="POST">
        ...
        <input type="text" name="image_url" placeholder="https://... (leave blank for a default image)">
